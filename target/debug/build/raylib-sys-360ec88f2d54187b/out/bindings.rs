...
pub const RAYGUI_VERSION: &[u8; 4usize] = b"3.2\0";
...
pub const RLGL_VERSION: &[u8; 4usize] = b"4.5\0";
...
pub struct GuiStyleProp {
    ...
    pub propertyValue: ::std::os::raw::c_uint,
}
#[test]
...
extern "C" {
    pub fn GuiPanel(bounds: Rectangle, text: *const ::std::os::raw::c_char);
}
extern "C" {
...
extern "C" {
    pub fn GuiTextInputBox(
        ...
        secretViewActive: *mut ::std::os::raw::c_int,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
...
extern "C" {
    pub fn GuiSetIconScale(scale: ::std::os::raw::c_uint);
}
extern "C" {
